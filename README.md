...
- **Settings tab** — the installed version (a static link to the Releases page) at the top, then three sub-tabs, grouped by purpose:
  ...
  - **Alerts** — **Auto-Honk** and **Interdiction Warning**, described above.
