...
- **Landing Pad** — an on-screen docking status and pad-layout diagram, showing which pad you're assigned as you request/approach a dock.
...
- **Settings tab** — the installed version (a static link to the Releases page) at the top, then five sub-tabs, one per feature:
  ...
  - **Auto-Honk**, **Interdiction Warning**, and **Landing Pad** — described above.
